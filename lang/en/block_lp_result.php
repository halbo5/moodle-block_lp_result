...
$string['text'] = 'Learning plan model :';
...
$string['competencyreport'] = "Grade this course competencies";
$string['noplanswarning'] = "No template plan to display";
$string['config_select_plan'] = "Choose a template plan";